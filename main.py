...
#解压数据集并将其移动至dataset中
get_ipython().system('tar -xf /home/aistudio/data/data90352/fire_detection.tar ')


# In[3]:


get_ipython().system('mv VOC2020 dataset ')
...
get_ipython().system('mkdir dataset/Annotations1')
...
get_ipython().system('mkdir dataset/Annotations2')
import xml.dom.minidom
import os
...
get_ipython().system('rm -rf dataset/Annotations')
get_ipython().system('rm -rf dataset/Annotations1')
get_ipython().system('mv dataset/Annotations2 dataset/Annotations')
...
get_ipython().system('paddlex --split_dataset --format VOC --dataset_dir /home/aistudio/dataset/ --val_value 0.2 --test_value 0.1')
